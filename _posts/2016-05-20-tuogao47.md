...
![1]({{ page.path }}/blog/tuogao/tougao47/1.jpg)<br>
...
![1]({{ page.path }}/blog/tuogao/tougao47/2.jpg)<br>
...
![1]({{ page.path }}/blog/tuogao/tougao47/3.jpeg)<br>
...
假设现在我需要一个圆角按钮，并且保证点击触发事件的范围必须要这个圆之内，那么通过一个`UIButton+LXDRuntime`的扩展来替换旧有`-pointInside:withEvent:`方法<br>
...
![1]({{ page.path }}/blog/tuogao/tougao47/4.jpeg)<br>
...
上面的代码只要去掉了`SEL aSelector`这个参数，这段代码就能正常执行。<br>
