...
没有缓存拖动过程截图<br>
![1]({{ page.path }}/blog/tuogao/tougao40/1.png)<br>

缓存后拖动过程截图<br>
![1]({{ page.path }}/blog/tuogao/tougao40/2.png)<br>
...
![1]({{ page.path }}/blog/tuogao/tougao40/3.png)<br>
...
![1]({{ page.path }}/blog/tuogao/tougao40/4.png)<br>

看第一个方法<br>

![1]({{ page.path }}/blog/tuogao/tougao40/5.png)<br>
...
![1]({{ page.path }}/blog/tuogao/tougao40/6.png)<br>
...
![1]({{ page.path }}/blog/tuogao/tougao40/7.png)<br>
...
![1]({{ page.path }}/blog/tuogao/tougao40/8.png)<br>
