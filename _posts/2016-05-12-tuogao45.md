...
![1]({{ page.path }}/blog/tuogao/tougao45/1.gif)<br>
...
![1]({{ page.path }}/blog/tuogao/tougao45/2.jpeg)<br>

上面的代码小小的改动一下，我们分别修改一下`maskView`和`contentView`的透明度，看看在遮罩透明度改变之后红色的视图会发生什么变化：

![1]({{ page.path }}/blog/tuogao/tougao45/3.jpeg)<br>
...
![1]({{ page.path }}/blog/tuogao/tougao45/4.jpeg)<br>
...
![1]({{ page.path }}/blog/tuogao/tougao45/5.gif)<br>
那么实现一个广告页轮播需要哪些步骤呢？
